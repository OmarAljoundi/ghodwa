import { House, LucideIcon, Newspaper, Settings2 } from "lucide-react";
...
> = {
  HomeSeo: {
    ...
    description:
      "Here you can configure the seo for the home page make it reach and awesome",
  },
  ...
  OverviewSeo: {
    ...
    description:
      "Here you can configure the seo for the overview page make it reach and awesome",
  },
  ...
  MissionVisionSeo: {
    ...
    description:
      "Here you can configure the seo for the mission page make it reach and awesome",
  },
  ...
  ContactUsSeo: {
    ...
    description:
      "Here you can configure the seo for the contact us page make it reach and awesome",
  },
