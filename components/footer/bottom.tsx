...
export function Bottom({ socialMediaContact }: BottomProps) {
  ...
  return (
    <div className="col-span-full md:col-span-2 lg:col-span-1 2xl:col-span-2 lg:flex-row items-start justify-start gap-x-6 xl:gap-x-12 flex flex-col-reverse gap-y-4 lg:gap-y-0">
